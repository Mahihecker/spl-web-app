  ...
  return (
    <div className="d-flex" style={{ minHeight: '100vh' }}>
      ...
      <div
        ...
        style={{ overflow: 'hidden', height: isSidebarOpen ? '645px' : '0' }}
      >
        {/* Toggle Icon */}
        <div
        ...
        <div className="mt-auto">
          <div className="d-flex align-items-center mb-2">
            ...
            <p className="text-muted ms-2 mb-0">Zeeshan Javed<br />hello@tailgrids.com</p>
          </div>
          <a
            href="/logout"
            className="nav-link d-flex align-items-center text-dark"
      ...
      <div className="flex-grow-1">
        ...
        <nav className="navbar navbar-light bg-light p-3">
          <div className="container-fluid">
            ...
            <input className="form-control w-25" type="search" placeholder="Search organizations" />
          </div>
        </nav>
        ...
        <footer className="bg-primary text-white p-3 text-center">
          ...
          <p className="mt-2">&copy; 2025. All rights reserved to Sign Language Production</p>
        </footer>
      </div>
    </div>
  );
